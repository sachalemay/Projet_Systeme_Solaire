...
int main(int argc, char * argv[]) {
	...
	for (int i = 1; i<lenght; i++) {
		//~ planets[i].distanceSoleil = 0; 
		//~ planets[i].x_cartesien = 0; 
		//~ planets[i].y_cartesien = 0; 
		//~ planets[i].previous_x_cartesien = 0; 
		//~ planets[i].previous_y_cartesien = 0; 
		//~ planets[i].distanceAsteroide = 0; 
	...
	//printf(" \n %d", NombrePointsWhile);
	printf("\ncolli X = %f  colli Y = %f",planets[asteroid.number_of_pl].x_cartesien, planets[asteroid.number_of_pl].y_cartesien);
	printf("\nAst X = %f  Ast Y = %f",asteroid.x_cartesien, asteroid.y_cartesien);
